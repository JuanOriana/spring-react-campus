        ...
        http
            ...
            .and()
                .authorizeRequests()
                    ...
                    .antMatchers(HttpMethod.GET, "/exams/{examId}").access("@antMatcherVoter.canAccessExamById(authentication, #examId)")
                    ...
                    .antMatchers(HttpMethod.GET, "/courses/{courseId}/exams/solved").access("@antMatcherVoter.isStudentInCourse(authentication, #courseId)")
                    .antMatchers(HttpMethod.GET, "/courses/{courseId}/exams/unsolved").access("@antMatcherVoter.isStudentInCourse(authentication, #courseId)")
                    ...
                    .antMatchers(HttpMethod.GET,"/files/extensions").hasAuthority("USER")
