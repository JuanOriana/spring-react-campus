...
@Controller
public class UserControllerEE extends AuthController {

    private final UserService userService;
    private static final Logger LOGGER = LoggerFactory.getLogger(UserControllerEE.class);

    @Autowired
    public UserControllerEE(AuthFacade authFacade, UserService userService) {
        super(authFacade);
