...
<html>
    <head>
        <title><spring:message code="course.page.title" htmlEscape="true" arguments="${course.subject.name}"/></title>
        <c:import url="config/generalHead.jsp"/>
    </head>
    <body>
    <div class="page-organizer">
        <%@ include file="components/navbar.jsp" %>
        <h2 class="course-section-name"><spring:message code="course.subject.name" htmlEscape="true" arguments="${course.subject.name}"/></h2>
                ...
                <div class="course-data-container">
                    ...
                    <c:forEach var="announcementItem" items="${announcementList}">
                        <div class="announcement-wrapper">
                            ...
                            <p class="announcement-date"><spring:message code="course.announcement.date" htmlEscape="true" arguments="${announcementItem.date}"/></p>
