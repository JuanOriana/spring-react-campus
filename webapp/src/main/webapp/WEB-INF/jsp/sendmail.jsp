...
<html>
<head>
    <title><spring:message code="sendmail.page.title" htmlEscape="true"/></title>
...
<div class="page-organizer">
    ...
    <div class="page-container">
        <form:form modelAttribute="mailForm" class="form-wrapper reduced" method="post" acceptCharset="utf-8">
            ...
            <form:label path="subject" for="subject" class="form-label"><spring:message code="sendmail.label.subject" htmlEscape="true"/></form:label>
            ...
            <form:label path="content" for="content" class="form-label"><spring:message code="sendmail.label.content" htmlEscape="true"/></form:label>
            ...
            <button class="form-button"><spring:message code="sendmail.button.send" htmlEscape="true"/></button>
        </form:form>
    </div>
